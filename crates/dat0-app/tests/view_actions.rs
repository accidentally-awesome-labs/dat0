...
use dat0_app::actions::builtin::ids;
use dat0_app::actions::{ActionId, ActionRegistry};

#[test]
fn view_undo_and_redo_are_registered() {
    let reg = ActionRegistry::new();
    dat0_app::actions::builtin::register_all(&reg).expect("register_all must not fail");
...
fn view_undo_and_redo_are_in_edit_group() {
    use dat0_app::actions::ActionGroup;
