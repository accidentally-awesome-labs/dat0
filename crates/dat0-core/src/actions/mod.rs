...
//!
//! [`builtin::register_all`] is invoked once at app boot; the resulting
//! registry is published process-wide so any subsystem (palette, banner, menu)
//! can look up an action by stable id.
