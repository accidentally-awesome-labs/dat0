...
#
#   .github/scripts/windowed-probes.sh [probe ...]    default: all eight
#
...
probes=("$@")
if [ ${#probes[@]} -eq 0 ]; then
  probes=(shell_probe window_probe modal_trap_probe settings_window_probe console_probe visual_probe grid_probe focus_probe)
fi
